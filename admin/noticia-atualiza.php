        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="categoria" id="categoria" required>
                    <option value=""></option>
                    <?php foreach ($recebeCategoria as $itemCategoria) { ?>
                        <option <?php if ($dados["categoria_id"] == $itemCategoria["id"]) echo " selected " ?> value="<?= $itemCategoria["id"] ?>"><?= $itemCategoria["nome"] ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" required type="text" id="titulo" value="<?= $dados["titulo"] ?>" name="titulo">
            </div>
