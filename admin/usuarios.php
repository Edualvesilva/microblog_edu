...
/* Verificando se quem está acessando esta página pode acessar (se o if do método abaixo for TRUE, então significa que o usuário NÃO é um admin e portanto esta página não será autorizada para uso) */
